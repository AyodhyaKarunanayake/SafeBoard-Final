...
class BookingProvider with ChangeNotifier {
  ...
  final List<RouteModel> sampleRoutes = [
    RouteModel(
      ...
      totalStops: 37,
      distanceKm: 396.0,
      routeType: 'Inter-Provincial Semi-Luxury AC',
      status: 'active',
      stops: const [
        'Colombo (Pettah)',
        'Kelaniya',
